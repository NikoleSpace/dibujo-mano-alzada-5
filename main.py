...
<script>
  ...
  function InitThis() {
      ...
      nota = ["Redonda", "Blanca", "Negra", "Corchea", "Semicorchea"];
...
<body onload="InitThis();">
    ...
    <div align="center">
      <img src="https://p3w3i6w2.rocketcdn.me/wp-content/uploads/2022/09/Diseno-sin-titulo.png" alt="Descripción de la imagen" width="500">
    </div>
</body>
</html>
...
def prepare_dataset():
    images = []
    d = ["Redonda", "Blanca", "Negra", "Corchea", "Semicorchea"]
    digits = []
    for digit in d:
...
if __name__ == "__main__":
    digits = ["Redonda", "Blanca", "Negra", "Corchea", "Semicorchea"]
    for d in digits:
